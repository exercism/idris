...
tests : List Test
tests =
  [ test "Missed target"                                            (assertEq (score (-9.0) (9.0)) 0)
  , test "On the outer circle"                                      (assertEq (score (0.0) (10.0)) 1)
  , test "On the middle circle"                                     (assertEq (score (-5.0) (0.0)) 5)
  , test "On the inner circle"                                      (assertEq (score (0.0) (-1.0)) 10)
  , test "Exactly on center"                                        (assertEq (score (0.0) (0.0)) 10)
  ...
  , test "Asymmetric position between the inner and middle circles" (assertEq (score (0.5) (-4.0)) 5)
  ]
